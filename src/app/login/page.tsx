...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 relative overflow-hidden flex items-center justify-center px-4">
      {/* Animated background */}
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/20 rounded-3xl p-8 md:p-10 shadow-2xl">
          ...
          >
            <div className="flex justify-center mb-4">
              <div className="p-3 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-full border border-cyan-500/30">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 text-white rounded-xl focus:outline-none focus:border-cyan-500/50 focus:bg-white/10 transition-all duration-300 placeholder-slate-500"
                />
              </div>
            </motion.div>
            ...
            <motion.button
              ...
              className="w-full py-3 mt-8 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 group"
            >
              {isLoading ? (
                <>
          ...
          <div className="flex items-center gap-3 my-8">
            ...
            <span className="text-xs text-slate-500 uppercase font-semibold">Ou continue com</span>
            <div className="flex-1 h-px bg-white/10"></div>
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full py-3 backdrop-blur-md bg-white/5 border border-white/10 hover:border-cyan-400/50 hover:bg-white/10 text-white font-semibold rounded-xl transition-all duration-300 flex items-center justify-center gap-3"
          >
